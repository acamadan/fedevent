...
console.log('Disk exists?', fs.existsSync('/app/data'));
console.log('DB exists?', fs.existsSync('/app/data/creata.db'));
...
// Built-in OCR fallback (no system deps): pdfjs + tesseract.js + canvas
...
async function ocrPdfText(pdfPath) {
  ...
  // Pure JS fallback using pdfjs + canvas + tesseract.js
